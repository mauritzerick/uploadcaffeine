...
- Dynamic OG images
- MDX blog
- Free tools (gradient maker, SFX panel, quote generator)
- Easter eggs (Matrix rain, flying coffee mugs, glitch mode)
...
```
🚀 Just launched my cyberpunk donation page for indie dev work in Australia!

Features:
☕ Neon UI with glitch effects
⚡ Stripe integration
🎮 Easter eggs galore
...
```
Excited to share my latest project: A cyberpunk-themed "buy me a coffee" platform built specifically for Australian indie developers.

🎨 Why I built it:
- Wanted full control over design
- Learning experience with Next.js 14
- No platform fees
- Showcase advanced web techniques
...
Good question! Platforms like Ko-fi and Patreon exist, but I wanted:
...
```

## Email to Local Dev Communities

```
Subject: Launched a new indie dev support platform (with neon vibes) 🇦🇺
...
- MDX-powered blog
- Free developer tools (gradient maker, SFX generator, quote tool)
- Interactive easter eggs
- Full SEO optimization

I built it as both a practical tool and a learning project using Next.js 14, TypeScript, and modern web technologies.
